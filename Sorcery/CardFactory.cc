...
CardFactory::CardFactory() {
    ...
    masterList.emplace_back(std::make_unique<Minion>(0, "Air Elemental", 0, 1, 1, std::unique_ptr<Ability>{}, ""));
    masterList.emplace_back(std::make_unique<Minion>(1, "Earth Elemental", 3, 4, 4, std::unique_ptr<Ability>{}, ""));

    masterList.emplace_back(std::make_unique<Minion>(2, "Bone Golem", 2, 1, 3, std::unique_ptr<Ability>{}, "Gain +1/+1 whenever a minion leaves play"));
    masterList.emplace_back(std::make_unique<Minion>(3, "Fire Elemental", 2, 2, 2, std::unique_ptr<Ability>{}, "When an opponent's minion enters play, deal 1 damage to it"));
    masterList.emplace_back(std::make_unique<Minion>(4, "Potion Seller", 2, 1, 3, std::unique_ptr<Ability>{}, "At the end of your turn, all your minions gain +0/+1"));
        // Novice Pyromancer
